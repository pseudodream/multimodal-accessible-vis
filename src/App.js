      ...
      <SessionProvider>
        <Container maxWidth="md">
          <Routes>
            ...
            <Route
              path={`stimuli/basic-tutorial`}
              element={<BasicTutorial />}
            ></Route>
            <Route
              path={`stimuli/basic-bar-chart`}
              element={<BasicBar />}
            ></Route>
            <Route
              path={`stimuli/basic-line-chart`}
              element={<BasicLine />}
            ></Route>
            <Route
              path={`stimuli/basic-scatter-plot`}
              element={<BasicScatterPlot />}
            ></Route>
            <Route path={`stimuli/basic-map`} element={<BasicMap />}></Route>

            <Route
              path={`stimuli/multimodal-tutorial`}
              element={<MultimodalTutorial />}
            ></Route>
            <Route
              path={`stimuli/multimodal-bar-chart`}
              element={<MultimodalBar />}
            ></Route>
            <Route
              path={`stimuli/multimodal-line-chart`}
              element={<MultimodalLine />}
            ></Route>
            <Route
              path={`stimuli/multimodal-scatter-plot`}
              element={<MultimodalScatterPlot />}
            ></Route>
            <Route
              path={`stimuli/multimodal-map`}
              element={<MultimodalMap />}
            ></Route>
            <Route
              path={`stimuli/speech-tutorial`}
              element={<SpeechTutorial />}
            ></Route>
            <Route
              path={`stimuli/speech-bar-chart`}
              element={<SpeechBar />}
            ></Route>
            <Route
              path={`stimuli/speech-line-chart`}
              element={<SpeechLine />}
            ></Route>
            <Route path={`stimuli/speech-map`} element={<SpeechMap />}></Route>
            <Route
              path={`stimuli/speech-scatter-plot`}
              element={<SpeechScatterPlot />}
            ></Route>
          </Routes>
        </Container>
      </SessionProvider>
